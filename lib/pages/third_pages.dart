...
class ThirdPage extends StatelessWidget {
  ...
  Widget _crearInput1() {
    return Container(
      ...
      child: TextFormField(
        decoration: InputDecoration(labelText: 'Nombre de la materia', hintText: 'Nombre de la materia'),
      ),
    );
  }
  ...
  Widget _crearInput3() {
    return Container(
      ...
      child: TextFormField(
        obscureText: true,
        decoration: InputDecoration(labelText: 'Creditos', hintText: 'Creditos'),
      ),
    );
  }
